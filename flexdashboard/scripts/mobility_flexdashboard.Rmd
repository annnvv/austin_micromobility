...
```{r avg_dist_by_hour}
## TODO: color working hours
## TODO: for this chart, set a reasonable upper-y limit!
...
shiny::renderPlot({
    ...
    geom_col() +
    geom_text(aes(label = format(round(avg_distance, 2), big.mark = ",")), vjust = 1.5, size = 2, col = 'white') +
    geom_text(aes(label = format(count, big.mark = ",")), vjust = -0.3, size = 2, col = 'blue') +
...
shiny::renderPlot({
    ...
    geom_col() +
    geom_text(aes(label = format(round(avg_duration, 2), big.mark = ",")), vjust = 1.5, size = 2, col = 'white') +
    geom_text(aes(label = format(count, big.mark = ",")), vjust = -0.3, size = 2, col = 'blue') +
