  ...
  raw <- RSocrata::read.socrata("https://data.austintexas.gov/resource/7d8e-dm7r.csv?month=5&vehicle_type=scooter",
  ...
  write_rds(raw, "02_raw_data/austin_mm_may_scooters.rds")
  
  raw <- readr::read_rds("02_raw_data/austin_mm_may_scooters.rds")
  ...
  write_rds(scooters_clean2, "03_clean_data/austin_mm_may_scooters_clean.rds") 
